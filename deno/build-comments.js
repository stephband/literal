...
export default function build(source, target, file, debug) {
    ...
    .then((template) => {
        ...
        return comments(source, target, file)
        .then((sections) => renderer.render(sections, include, imports, comments))
        .then(library.DEBUG ?
